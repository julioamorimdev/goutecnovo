        ...
        if (empty($_FILES['logo_file']) || $_FILES['logo_file']['error'] !== UPLOAD_ERR_OK) {
            ...
            if (!in_array($ext, ['png','jpg','jpeg','webp','svg'], true)) {
                ...
                if (!move_uploaded_file($tmp, $dest)) {
                    ...
                    $publicPath = '/admin/assets/img/logos/' . $filename;
    ...
    if ($action === 'delete') {
        ...
        if ($id > 0) {
            ...
            if ($row) {
                ...
                if (str_starts_with($fp, '/admin/assets/img/logos/')) {
                    $real = __DIR__ . '/..' . $fp;
...
$defaultLight = '/admin/assets/img/logo-light.png';
$defaultDark = '/admin/assets/img/logo-dark.png';
?>
