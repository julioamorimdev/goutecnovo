...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($action === 'create_backup') {
            ...
            // Obter configurações do banco (usando variáveis de ambiente como no bootstrap.php)
            $dbHost = env('DB_HOST', '127.0.0.1');
            $dbPort = env('DB_PORT', '3306');
            $dbName = env('DB_NAME', 'goutecnovo');
            $dbUser = env('DB_USER', 'goutecnovo');
            $dbPass = env('DB_PASS', 'goutecnovo_pass');
