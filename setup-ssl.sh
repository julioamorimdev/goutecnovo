...
# Script para configurar SSL com certbot para goutec.com.br
# Este script obtém um certificado Let's Encrypt e configura renovação automática
...
# Configuração HTTPS para goutec.com.br
...
server {
    ...
    # Certificados SSL
    ssl_certificate /etc/letsencrypt/live/goutec.com.br/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/goutec.com.br/privkey.pem;
    ...
    ssl_trusted_certificate /etc/letsencrypt/live/goutec.com.br/chain.pem;
...
echo "  /etc/letsencrypt/live/goutec.com.br/"
echo ""
